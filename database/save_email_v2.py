        ...
        try:
            ...
            with connection.cursor() as cursor:
                cursor.execute("""
                  ...
                  WHERE 
                       sent_status = %s
                        AND LOWER(users.email) NOT LIKE 'postmaster@%' 
                        AND LOWER(users.email) NOT LIKE 'mailer-daemon@%' 
                        AND LOWER(users.email) NOT LIKE 'no-reply@%' 
                        AND LOWER(users.email) NOT LIKE 'sc-noreply@%'
